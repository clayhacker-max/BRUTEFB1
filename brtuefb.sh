...
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : Mr.gaming                  |" | lolcat
echo  "|              Youtube         : JOMBLO KAWE                |" | lolcat
echo  "|              Blog            : notpount                   |" | lolcat
...
echo $i"|"$me" 19"$" |"$pu" BRUTETARGET FB (Mr.Gaming)"
...
figlet -f slant "WAIT"|lolcat
sleep 1
https://github.com/clayhacker-max/hackfbtarget
cd hackfacebooktarget
python2 Target.py
exit
fi